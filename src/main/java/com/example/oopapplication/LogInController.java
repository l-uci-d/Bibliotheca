...
public class LogInController {
    ...
    @FXML
    private AnchorPane anchorPaneRoot, anchorPaneMain, anchorPaneSI, anchorPaneSU, anchorPaneCover;
    @FXML
    private ImageView imgViewBG;
    @FXML
    private Button btnSI, btnHeaderButton, btnSU;
    @FXML
    private Label lblClock, lblDate, lblSubHeader, lblTitle, lblSubHeader1, lblShow, lblShowSU, lblShowSU1;
    @FXML
    private TextField txtSINumber, txtFName, txtLName, txtPass, txtPassSU, txtPassSU1;
    @FXML
    private PasswordField passSi, passSU1, passSU;
    @FXML
    private Text txtSucc, lblSUError, lblSIError;    public String currentSY = getCurrentSYSEM("SY"),
            currentSem = getCurrentSYSEM("Sem");
    private boolean isSIMode = true;
    private final Integer[] year = {1, 2, 3, 4};
    ...
    public void signUp() {//////////////////////////////////////////////////////////////////////////////////////
        ...
        }else lblSUError.setText("Please fill up both First and Last names.");
                ...
                if (usertype.equals("E")) {             //checks user type// if admin
                    ...
                    dropdown.setOnFinished((event1) -> {
                        try {
                            ...
                            stage.setScene(scene);
                            mainMenuController.initialize2();
                            stage.show();
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
